        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="w-full h-full flex justify-center">
             <Image
                ...
                alt="The elegant interior of b s"
                width={500}
                height={700}
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              b s began with a simple dream. Our founder, Sai, a young man from a middle-class background, envisioned a place where exquisite food could be enjoyed by everyone. At just 21 years old, with unwavering support from his family, he turned that dream into a reality.
            </p>
            <p className="mt-4 text-lg text-muted-foreground">
